                ...
                {loading ? (
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mt-4 flex gap-3">
                            ...
                            <button onClick={() => { /* TODO: integrar checkout real */ console.log('Checkout no implementado'); }} className="px-3 py-2 bg-green-600 text-white rounded">Proceder al pago</button>
                        </div>
                    </div>
                )}
            </nav>
